    ...
    async def execute_pipeline(
        ...
        try:
            ...
            if not workflow_content:
                await log("⚠️ AI didn't generate workflow, creating fallback...")
...
"""
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            for attempt in range(120):  # 120 * 10s = 20 minutes
                ...
                if runs_response.status_code == 200:
                    ...
                    await log("⚠️ Failed to check workflow status")
                    await asyncio.sleep(10)
    ...
    async def _validate_github_access(self, repo: str, gh_token: str, log) -> None:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            ...
            if missing_scopes:
                await log(f"⚠️ Missing GitHub token scopes: {', '.join(missing_scopes)}")
            ...
            if actions_response.status_code == 200:
                ...
                await log("⚠️ Could not verify GitHub Actions status (this is normal for some repositories)")