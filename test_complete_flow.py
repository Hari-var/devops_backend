...
async def test_complete_devops_flow():
    ...
    print("\nTesting AI Terraform Generation...")
    try:
    ...
    print("\nTesting Build Steps Generation...")
    try:
        flow_manager = PipelineFlowManager()
    ...
    if success_count == total_tests:
        ...
        print("\nSeveral tests failed. Please check the configuration and dependencies.")
